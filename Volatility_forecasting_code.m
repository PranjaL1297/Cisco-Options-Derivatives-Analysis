...
%*******************!Set Dates Here!***************************************
tradeDate = datenum('31102023','ddmmyyyy');
%                   ~~~~~~~~~~
expiryDate = datenum('24112023','ddmmyyyy');
%                   ~~~~~~~~~~
...
%
fprintf('************************************************************* \n');
fprintf('Loaded Daily CSCO data from %s to %s \n', ...
    datestr(min(sp500Dates)),datestr(max(sp500Dates)));

%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% Load VIX data
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
VIX = csvread('VIX(FF).csv',1);
